...
section.about-me
  .about-me__wrap-title
    h1.about-me__title.content-container__title Блок «Обо мне»
    button.about-me__bth-add-group(type="button") Добавить группу
  .about-me__wrappers
    .group-skills
      .group-skills__item.skill-item
        .skill-item__wrapper
          form.skill-item__form-new-group.form-group(
            ...
            .form-group__name-group
              .form-group__input-wrap
                .form-group__input-container
                  label(for="new-group")
                    <svg x="0px" y="0px" width="528.899px" height="528.899px" viewBox="0 0 528.899 528.899" style="enable-background:new 0 0 528.899 528.899;"xml:space="preserve">
        ...
        .form-group__input-items
          .form-group__input-container
            ...
            .form-group__btn
              ...
              button(type="button", @click="deleteCategories(cat.id)")
                <svg x="0px" y="0px" viewBox="0 0 174.239 174.239" style="enable-background:new 0 0 174.239 174.239;" xml:space="preserve">
          ...
          .form-group__input-wrap
            ...
            .form-group__skills
              form.form-group__skills-wrap(
                @submit.prevent="createNewSkill(cat.id)"
              )
                label(for="new-skill")
                input#new-skill(
                  type="text",
...
export default {
  ...
  methods: {
    ...
    ...mapActions("skills", ["addSkill", "fetchSkills"]),

    async createNewSkill(id) {
      const newSkillObj = { ...this.skill, category: id };
      console.log(id, newSkillObj);
      try {
        await this.addSkill(newSkillObj);
      } catch (err) {
        console.log(err);
      }
    },
...
.content-container__block-title {
  font-size: 18px;
  line-height: 34px;
  font-weight: 700;
}
...
.form-group__name-group input::placeholder {
  font-size: 18px;
  line-height: 34px;
}

.form-group__skills input::placeholder {
  font-size: 16px;
}
